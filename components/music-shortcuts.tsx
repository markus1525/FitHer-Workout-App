...
const MUSIC_APPS: MusicApp[] = [
  ...
  // Flow Myanmar: this page is an app link, so opening it hands off to the Flow
  // app (directly if installed, otherwise the site offers an "Open" button).
  { key: "flow", label: "Flow", color: "#8B2FC9", appUrl: "https://www.flowmyanmar.com/login", webUrl: "https://www.flowmyanmar.com/login" },
];
